...
{
    static std::string resourcesPath = GetBundlePath() + "/";

    static std::string fullPath = CCFileUtils::sharedFileUtils()->fullPathForFilename(resourcesPath.c_str());
