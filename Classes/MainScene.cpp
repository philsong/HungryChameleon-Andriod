...
bool MainScene::init()
{
    ...
    m_pBackground->RegisterTouchCallback((void*)this);
	//m_pBackground->RegisterTouchBeganCallback((PFNCB)&(MainScene::OnTouchEnded));
	//m_pBackground->RegisterTouchMovedCallback((PFNCB)&(MainScene::OnTouchMoved));
...
bool MainScene::LoadGameSettings()
{
    ...
    pBuffer = CCFileUtils::sharedFileUtils()->getFileData("game_settings.xml", "r", &bufferSize);
